...
@section('content')
 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Data Blog</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= route('berita-update',['id_berita'=>$berita->id_berita]) ?>" method="POST" enctype="multipart/form-data">
	{{csrf_field() }}
	{{method_field('PATCH') }}
  ...
  <div class="form-group{{$errors->has('gambar') ? 'has-error':'has-success'}}">
    ...
    <input type="file" class="form-control" id="gambar" name="gambar" value="{{asset('fotoupload/'. $berita->gambar)}}">

    @if($errors->has('gambar'))
    <span class="help-block"> {{$errors->first('gambar')}}</span>
    @endif
    <br>
    <img src="{{asset('fotoupload/'. $berita->gambar)}}" height="200px" width="200px">
  </div>
  <br>
  <div class="form-group{{$errors->has('konten') ? 'has-error':'has-success'}}">
    <label class="control-label" for="konten">Isi Blog</label>
    <textarea type="text" class="form-control" rows="5" id="konten" name="konten" ><?= $berita->konten?></textarea>
