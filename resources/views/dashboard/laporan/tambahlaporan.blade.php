...
@section('content')
 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Tambah Data Laporan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <div class="form-group{{$errors->has('judul_laporan') ? 'is-invalid':'is-valid'}}">
    ...
    <input type="text" class="form-control" id="judul_laporan" name="judul_laporan" value="{{old('judul_laporan')}}" >
  ...
  <div class="form-group{{$errors->has('file_laporan') ? 'has-error':'has-success'}}">
    ...
    <input type="file" class="form-control" id="file_laporan" name="file_laporan" value="{{old('file_laporan')}}">
