...
@section('content')
 ...
 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Tambah Data Investor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Tambah Data Investor</h3>
              </div>
               @include('errors.form_error_list')
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= route('investor-store') ?>" method="post" enctype="multipart/form-data">
    {{csrf_field() }}
    <div class="modal-body">
  <div class="form-group{{$errors->has('nama') ? 'is-invalid':'is-valid'}}">
  ...
  <div class="form-group{{$errors->has('foto') ? 'has-error':'has-success'}}">
   <label class="control-label" for="foto">Foto KTP</label>
  ...
  <br>
  <div class="form-group{{$errors->has('pekerjaan') ? 'has-error':'has-success'}}">
  ...
  <div class="form-group{{$errors->has('email') ? 'has-error':'has-success'}}">
    <label class="control-label" for="no_telp">Email</label>
